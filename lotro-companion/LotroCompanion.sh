...
CLASSPATH=lib/commons-codec-1.2.jar
CLASSPATH=${CLASSPATH}:lib/commons-httpclient-3.1.jar
CLASSPATH=${CLASSPATH}:lib/commons-logging-1.0.4.jar
CLASSPATH=${CLASSPATH}:lib/delta-common-1.1-SNAPSHOT.jar
CLASSPATH=${CLASSPATH}:lib/delta-downloads-1.1-SNAPSHOT.jar
CLASSPATH=${CLASSPATH}:lib/delta-json-1.0.jar
CLASSPATH=${CLASSPATH}:lib/delta-lotro-1.1-SNAPSHOT.jar
